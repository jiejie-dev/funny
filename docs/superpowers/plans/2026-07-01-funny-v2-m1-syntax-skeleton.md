...
```
v2/
├── go.mod                              # module github.com/jiejie-dev/funny
├── README.md
├── .gitignore
├── cmd/
│   └── funny/
...
- [ ] Create directory and init module: `mkdir -p /Users/j/repos/funny/v2 && cd /Users/j/repos/funny/v2 && go mod init github.com/jiejie-dev/funny`
