...
import "github.com/jerloo/funny/v2/internal/bytecode"
...
This requires importing `github.com/jerloo/funny/v2/internal/ast` in `expression.go` if not already present (it is).
